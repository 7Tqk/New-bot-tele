...
API_TIMEOUT = 60  # رفع المهلة إلى دقيقة كاملة لضمان عدم حدوث تايماوت للبوابات البطيئة
BIN_TIMEOUT = 15
PROXY_TIMEOUT = 12
DELAY = 0.05
HIT_DELAY = 1.0
...
def format_proxy_for_api(proxy):
    """ تنظيف وتطهير البروكسي من أي زوائد ليتوافق 100% مع المدخلات المطلوبة في سيرفرك """
    if not proxy: return ""
